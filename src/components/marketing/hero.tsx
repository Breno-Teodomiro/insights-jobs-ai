...
const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <BlurText
                word={"Agentes de IA Estratégicos\n para seu Negócio"}
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Consultoria especializada em Inteligência Artificial para transformar sua empresa. <span className="hidden sm:inline">Desenvolvemos agentes IA personalizados que otimizam processos, reduzem custos operacionais em até 40% e aceleram seu crescimento.</span>
                </p>
            </Container>
            <Container delay={0.2}>
